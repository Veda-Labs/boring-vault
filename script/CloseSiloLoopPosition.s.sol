 ...
 */
contract CloseSiloLoopPosition is Script, MerkleTreeHelper {
    ...
    function run() public {
        ...
        // approve USDC spend on silo
        // repay USDC loan
        // withdraw collateral
        // sell collateral for SY
        // unwrap SY for sUSDf
        // redeem USDf
        // sell USDf for USDC
        ...
        returns (bytes32[][] memory flashloanManageProofs)
    {
        ...
        // approve debt silo to spend usdc
        ...
        flashloanLeafs[0].argumentAddresses[0] = silo1;
        ...
        // redeem PT-sUSDf supplied shares from silo0
        ...
        flashloanLeafs[3].argumentAddresses[1] = getAddress(sourceChain, "LP_sUSDf_9_25_2025");
