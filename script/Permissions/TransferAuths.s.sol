...
/**
 *  source .env && forge script script/Permissions/TransferAuths.s.sol:Deploy --fork-url  $MAINNET_RPC_URL --verify --slow  -vvvv --broadcast
 */
contract Deploy is Script {
    ...
    function run() external {
        ...
        for (uint8 i = 0; i < rolesAuthority.length; i++) {
            ...
            currentRolesAuthority.transferOwnership(vaultSystemOwner);
        }
