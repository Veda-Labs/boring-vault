...
/**
 *  source .env && forge script script/DeployiPrvlAgent1WETHMainnetDecoderAndSanitizer.s.sol:Deploy --broadcast --verify -vvvv --slow
 */
contract Deploy is Script, Test, ContractNames, SepoliaAddresses {
    ...
    //Agent1 Vault
    address boringVault = 0x8503B18b279Fd0f1EC35303D8db834619A12250f;
    ...
    function run() external {
        ...
        deployer.deployContract("iPrvlAgent1WETH Decoder and Sanitizer V0.1", creationCode, constructorArgs, 0);
