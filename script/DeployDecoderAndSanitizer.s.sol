...
contract DeployDecoderAndSanitizerScript is Script, ContractNames, MainnetAddresses, MerkleTreeHelper {
    ...
    function run() external {
        ...
        constructorArgs = abi.encode(uniswapV3NonFungiblePositionManager, odosRouterV2);
        console.logBytes(constructorArgs);
        deployer.deployContract("EtherFi Liquid Eth Decoder And Sanitizer V2.0", creationCode, constructorArgs, 0);
