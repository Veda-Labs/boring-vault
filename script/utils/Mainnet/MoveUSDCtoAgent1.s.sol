...
/*
 * source .env && forge script script/utils/Mainnet/MoveUSDCtoAgent1.s.sol:MoveFunds --fork-url mainnet --broadcast -vvvvv
 */
contract MoveFunds is Script, MerkleTreeHelper {
    ...
    function run() external {
        ...
        uint256 amount = ERC20(usdc).balanceOf(CLIENT_VAULT) / 10;
