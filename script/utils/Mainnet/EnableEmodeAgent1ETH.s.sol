...
/*
 * source .env && forge script script/utils/Mainnet/EnableEmodeAgent1ETH.s.sol:EnableEmodeAgent1ETH --rpc-url mainnet --broadcast -vv
 */

contract EnableEmodeAgent1ETH is Script, MerkleTreeHelper {
    ...
    function run() external {
        ...
        bytes32[] memory proof = getMerkleProof(json, 0x17314b54f90d3225eb2607cbb7dfb4b17050c379bb821c8c39a0969fd0809fad);
        ...
        decodersAndSanitizers[0] = 0xEb669E30f7A332FbEe9D3FCF3281e244F1539F49; // Base decoder
