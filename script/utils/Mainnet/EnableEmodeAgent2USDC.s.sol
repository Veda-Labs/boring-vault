...
contract EnableEmodeAgent1USDC is Script, MerkleTreeHelper {
    ...
    address constant AAVE_POOL = 0x4e033931ad43597d96D6bcc25c280717730B58B1; // core v3 pool
    ...
    function run() external {
        ...
        bytes32[] memory proof = getMerkleProof(json, 0xaa902580051b0ad70379a5a32af578b4c43c18c6a5fb2d158ffa7ce3166eb59a);
        
        // Prepare the target data for enabling eMode
        // setUserEMode(uint8) where uint8 = 1 for ETH correlated assets eMode
        bytes memory targetData = abi.encodeWithSignature("setUserEMode(uint8)", 4);
        ...
        decodersAndSanitizers[0] = 0x1F1fA55c7f1bEc9A056De9C5fA82792B5D6d6844; // Base decoder
