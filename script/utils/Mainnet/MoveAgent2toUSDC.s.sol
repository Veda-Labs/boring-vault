...
/*
 * source .env && forge script script/utils/Mainnet/MoveAgent2toUSDC.s.sol:MoveFunds --fork-url mainnet --broadcast -vvvvv
 */
contract MoveFunds is Script, MerkleTreeHelper {
    ...
    function run() external {
        ...
        uint256 amount = ERC20(TARGET_AGENT_VAULT).balanceOf(CLIENT_VAULT)* 99 / 100;
