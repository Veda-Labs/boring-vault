...
/*
 *  source .env && forge script script/utils/Mainnet/UpdateSharePriceConfigAll.s.sol:UpdateAll --rpc-url $MAINNET_RPC_URL -vvvv --broadcast
 */

contract UpdateAll is Script {
    ...
    function run() external {
        ...
        for (uint256 i = 0; i < accountantsWithRoles.length; i++) {
            ...
            //ACCOUNTANT.updateDelay(1800);
            ACCOUNTANT.updateLower(uint16(9900));
            ACCOUNTANT.updateUpper(uint16(10100));
        }
