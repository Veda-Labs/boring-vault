...
import {
    LucidlyChainlinkRoycoVaultTrancheOracleV1
} from "src/adapters/oracle/LucidlyChainlinkRoycoVaultTrancheOracleV1.sol";
import "forge-std/Script.sol";
import "forge-std/StdJson.sol";

contract DeployLucidlyChainlinkRoycoVaultTrancheOracleV1Script is Script {
    ...
    function run(string memory configFile) external {
        ...
        bytes memory creationCode = type(LucidlyChainlinkRoycoVaultTrancheOracleV1).creationCode;
        bytes memory constructorArgs = abi.encode(
            json.readAddress(".tranche"),
