...
contract CreateLombardMerkleRootScript is Script, MerkleTreeHelper {
    ...
    function generateLombardStrategistMerkleRoot() public {
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "BTCb_cbBTC_Curve_Pool"),
            2,
            getAddress(sourceChain, "BTCb_cbBTC_Curve_Gauge")
        );
        _addCurveLeafs(
            leafs, getAddress(sourceChain, "BTCb_WBTC_Curve_Pool"), 2, getAddress(sourceChain, "BTCb_WBTC_Curve_Gauge")
        );
        _addCurveLeafs(
            leafs, getAddress(sourceChain, "BTCb_LBTC_Curve_Pool"), 2, getAddress(sourceChain, "BTCb_LBTC_Curve_Gauge")
        );
