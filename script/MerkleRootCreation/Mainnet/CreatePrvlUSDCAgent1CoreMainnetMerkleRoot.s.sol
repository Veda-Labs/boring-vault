...
/**
 *  source .env && forge script script/MerkleRootCreation/Mainnet/CreatePrvlUSDCAgent1CoreMainnetMerkleRoot.s.sol:USDCAgent1 --rpc-url mainnet
 */
...
contract USDCAgent1 is Script, MerkleTreeHelper {
    ...
    function setUp() external {
        boringVault = 0x7e68c279EA86FA49A49Eef2Cbb79B9cBfBc48025; // Agent vault address
        managerAddress = 0x28d0D9C4553c24aBf55CBd0680B03524eeC966Aa; // Manager address  
        accountantAddress = 0xc8C3fAc6d267002868Dd5D528dA15b72Dbb681A5; // Accountant address
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Mainnet/USDCAgent1CORE.json";
