...
/**
 *  source .env && forge script script/MerkleRootCreation/Mainnet/CreatePrvlWETHAgent2PrimeMainnetMerkleRoot.s.sol:WETHAgent2 --rpc-url mainnet
 */
...
contract WETHAgent2 is Script, MerkleTreeHelper {
    ...
    function setUp() external {
        ...
        rawDataDecoderAndSanitizer = 0xc5c641525Bbf2fD6d163c138101F82c1ca4FBaaE; // Deployed decoder address
    }
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Mainnet/ETHAgent2Prime.json";
