    ...
    function generateStrategistMerkleRoot() public {
        ...
        // aave PYUSD
        {
            ...
            _addLeafsForITBPositionManager(
                leafs, aavePYUSDPositionManager, aavePYUSDTokensUsed, "Aave PYUSD ITB Position Manager"
            );
        }
        {
            // aave RLUSD
            ...
            _addLeafsForITBPositionManager(
                leafs, aaveRLUSDPositionManager, aaveRLUSDTokensUsed, "Aave RLUSD ITB Position Manager"
            );
        }
        {
            // Euler RLUSD
            ...
            _addLeafsForITBPositionManager(
                leafs, eulerRLUSDPositionManager, eulerRLUSDTokensUsed, "Euler RLUSD ITB Position Manager"
            );
        }
        {
            // Morpho PYUSD
            ...
            _addLeafsForITBPositionManager(
                leafs, morphoPYUSDPositionManager, morphoPYUSDTokensUsed, "Morpho PYUSD ITB Position Manager"
            );
        }
        {
            // Euler PYUSD
            ...
            _addLeafsForITBPositionManager(
                leafs, eulerPYUSDPositionManager, eulerPYUSDTokensUsed, "Euler PYUSD ITB Position Manager"
            );
        }
        {
            // Euler USDC
            ...
            _addLeafsForITBPositionManager(
                leafs, eulerUSDCPositionManager, eulerUSDCTokensUsed, "Euler USDC ITB Position Manager"
            );
        }
        {
            ...
            _addLeafsForITBPositionManager(
                leafs, curvePYUSD_USDCPositionManager, curveTokensUsed, "Curve PYUSD/USDC ITB Position Manager"
            );
        }
        // ========================== Verify ==========================
