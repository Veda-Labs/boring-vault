...
/**
 *  source .env && forge script script/MerkleRootCreation/Mainnet/CreatePrvlWETHAgent2PrimeMainnetMultiHopMerkleRoot.s.sol:WETHAgent2Prime --rpc-url mainnet
 */
...
contract WETHAgent2Prime is Script, MerkleTreeHelper {
    ...
    function setUp() external {
        boringVault = 0x951f36b2F8Fd8B213AE999E53dF1c77749A6cDed; // Agent vault address
        managerAddress = 0x618c13371DB671AdbCbA93e76f758E307E6A0871; // Manager address
        accountantAddress = 0x6c0EAFB69D8F858397077f900edEc01345Aa0FFF; // Accountant address
        wstETH = 0x7f39C581F595B53c5cb19bD0b3f8dA6c935E2Ca0;
        rawDataDecoderAndSanitizer = 0xdda148b36E80d28EEF153c570891B628cb2540f1;
    }
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        if (!ownerToTokenToSpenderToApprovalInTree[getAddress(sourceChain, "boringVault")][getAddress(sourceChain, "DAI")][swapRouter02]) {
            ...
            leafs[leafIndex] = ManageLeaf(
                ...
                new address[](1),
                "Approve SwapRouter02 to spend WETH",
                getAddress(sourceChain, "rawDataDecoderAndSanitizer")
            );
            leafs[leafIndex].argumentAddresses[0] = swapRouter02;
            ownerToTokenToSpenderToApprovalInTree[getAddress(sourceChain, "boringVault")][getAddress(sourceChain, "WETH")][swapRouter02] = true;
        }

        // Approve wstETH for SwapRouter02
        ...
        // Multi-hop swap leaf: WETH -> wstETH
        unchecked {
            leafIndex++;
        }
        leafs[leafIndex] = ManageLeaf(
            ...
            new address[](3),  // 2 tokens + recipient
            "Multi-hop swap: WETH -> wstETH",
            getAddress(sourceChain, "rawDataDecoderAndSanitizer")
        );
        leafs[leafIndex].argumentAddresses[0] = getAddress(sourceChain, "WETH");
        leafs[leafIndex].argumentAddresses[1] = getAddress(sourceChain, "wstETH");
        leafs[leafIndex].argumentAddresses[2] = getAddress(sourceChain, "boringVault");

        // Multi-hop swap leaf (reverse): wstETH> WETH
        unchecked {
            leafIndex++;
        }
        leafs[leafIndex] = ManageLeaf(
        ...
        string memory filePath = "./leafs/Mainnet/WETHAgent2Prime.json";
