...
/**
 *  source .env && forge script script/MerkleRootCreation/Mainnet/CreatePrvlWETHAgent1CoreMainnetMultiHopMerkleRoot.s.sol:WETHAgent1 --rpc-url mainnet
 */
...
contract WETHAgent1 is Script, MerkleTreeHelper {
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Mainnet/WETHAgent1CORE.json";
