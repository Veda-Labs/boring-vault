...
contract CreateSonicLBTCvMerkleRootScript is Script, MerkleTreeHelper {
    ...
    function generateSonicLBTCvStrategistMerkleRoot() public {
        ...
        // ========================== BoringVaults ==========================
        {
            ...
            _addTellerLeafs(leafs, eBTCTeller, eBTCTellerAssets, true, true);
            ...
            _addCrossChainTellerLeafs(
                ...
                _feeAssets,
                abi.encode(layerZeroSonicMainnetEndpointId)
            );
            ...
            _addWithdrawQueueLeafs(
                leafs,
                eBTCOnChainQueueFast,
                getAddress(sourceChain, "scBTC"),
                _scBTCWithdrawQueueAssets
            );
        }
        ...
        string
            memory filePath = "./leafs/Mainnet/SonicLBTCvStrategistLeafs.json";
