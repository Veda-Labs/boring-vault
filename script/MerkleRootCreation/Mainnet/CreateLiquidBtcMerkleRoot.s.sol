...
contract CreateLiquidBtcMerkleRoot is Script, MerkleTreeHelper {
    ...
    address public rawDataDecoderAndSanitizer =
        0x74522D571f80FF8024b176d710cD963002aC4278;
    address public scrollBridgeDecoderAndSanitizer =
        0xA66a6B289FB5559b7e4ebf598B8e0A97C776c200;
    ...
    function generateAdminStrategistMerkleRoot() public {
        ...
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTC_USDC_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTC_USDT_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "Corn_eBTC_PT03_LBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "LBTC_PT03_LBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "LBTC_PT03_WBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "LBTC_PT03_WBTC_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "EBTC_USDC_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "EBTC_USR_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "Corn_eBTC_PT03_2025_WETH_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "WBTC_USR_86")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "Corn_eBTC_PT03_2025_WBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "eUSDe_PT05_2025_USDC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "MCUSR_USD0_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "MCUSR_USDC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "EBTC_PT06_26_25_LBTC_915")
        );
        _addMorphoBlueSupplyLeafs(
            leafs,
            getBytes32(sourceChain, "sdeUSD_USDC_915")
        );
        ...
        _addMorphoBlueCollateralLeafs(
            leafs,
            getBytes32(sourceChain, "wstUSR_PT03_USR_915")
        );
        _addMorphoBlueCollateralLeafs(
            leafs,
            getBytes32(sourceChain, "WBTC_USR_86")
        ...
        _addMorphoRewardMerkleClaimerLeafs(
            leafs,
        ...
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_USD0++_market_01_29_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_USD0++_market_06_25_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_eBTC_corn_market_3_26_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
        ...
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_LBTC_market_03_26_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_LBTC_corn_market_02_26_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_liquidBeraBTC_04_09_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_eBTC_market_06_25_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_wstUSR_market_03_26_25"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_tETH_03_28_2025"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_beraSTONE_04_09_2025"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_syrupUSDC_04_23_2025"),
            true
        );
        _addPendleMarketLeafs(
            leafs,
            getAddress(sourceChain, "pendle_eUSDe_05_28_2025"),
            true
        );
        ...
        // ========================== Teller ==========================
        {
            ...
            _addCrossChainTellerLeafs(
                ...
                eBTCTellerAssets2,
                feeAssets,
                abi.encode(layerZeroBerachainEndpointId)
            );
            ...
            _addTellerLeafs(
                leafs,
                newLiquidBeraBTCTeller,
                liquidBeraBTCTellerAssets,
                false,
                true
            );
            ...
            _addTellerLeafs(
                leafs,
                getAddress(sourceChain, "TurtleTACBTCTeller"),
                tacBTCAssets,
                false,
                false
            );
            _addWithdrawQueueLeafs(
                leafs,
                getAddress(sourceChain, "TurtleTACBTCQueue"),
                getAddress(sourceChain, "TurtleTACBTC"),
                tacBTCAssets
            );
            ...
            _addTellerLeafs(
                leafs,
                getAddress(sourceChain, "TACLBTCvTeller"),
                tacLBTCvAssets,
                false,
                false
            );
            _addWithdrawQueueLeafs(
                leafs,
                getAddress(sourceChain, "TACLBTCvQueue"),
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "fxUSD_USDC_Curve_Pool"),
            2,
            getAddress(sourceChain, "fxUSD_USDC_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "fxUSD_USDC_Curve_Pool")
        );
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "WETH_PXETH_Curve_Pool"),
            2,
            getAddress(sourceChain, "WETH_PXETH_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "WETH_PXETH_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "STETH_PXETH_Curve_Pool"),
            2,
            getAddress(sourceChain, "STETH_PXETH_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "STETH_PXETH_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "FXUSD_GHO_Curve_Pool"),
            2,
            getAddress(sourceChain, "FXUSD_GHO_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "FXUSD_GHO_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "TBTC_EBTC_Curve_Pool"),
            2,
            getAddress(sourceChain, "TBTC_EBTC_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "TBTC_EBTC_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "TBTC_CBBTC_Curve_Pool"),
            2,
            getAddress(sourceChain, "TBTC_CBBTC_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "TBTC_CBBTC_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "frxUSD_FRAX_Curve_Pool"),
            2,
            address(0)
        ); //no gauge currently
        _addLeafsForCurveSwapping(
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "frxUSD_SUSDS_Curve_Pool"),
            2,
            getAddress(sourceChain, "frxUSD_SUSDS_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "frxUSD_SUSDS_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "frxUSD_USDE_Curve_Pool"),
            2,
            getAddress(sourceChain, "frxUSD_USDE_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "frxUSD_USDE_Curve_Pool")
        ...
        _addCurveLeafs(
            leafs,
            getAddress(sourceChain, "triBTCFi_Curve_Pool"),
            3,
            getAddress(sourceChain, "triBTCFi_Curve_Gauge")
        );
        _addLeafsForCurveSwapping(
            leafs,
            getAddress(sourceChain, "triBTCFi_Curve_Pool")
        ...
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "WETH_PXETH_Curve_Pool"),
            getAddress(sourceChain, "WETH_PXETH_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "STETH_PXETH_Curve_Pool"),
            getAddress(sourceChain, "STETH_PXETH_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "FXUSD_GHO_Curve_Pool"),
            getAddress(sourceChain, "FXUSD_GHO_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "TBTC_EBTC_Curve_Pool"),
            getAddress(sourceChain, "TBTC_EBTC_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "TBTC_CBBTC_Curve_Pool"),
            getAddress(sourceChain, "TBTC_CBBTC_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "frxUSD_SUSDS_Curve_Pool"),
            getAddress(sourceChain, "frxUSD_SUSDS_Convex_Rewards")
        );
        _addConvexLeafs(
            leafs,
            getERC20(sourceChain, "frxUSD_USDE_Curve_Pool"),
            getAddress(sourceChain, "frxUSD_USDE_Convex_Rewards")
        );
        ...
        _addLayerZeroLeafs(
            ...
            getAddress(sourceChain, "stargateSolvBTC"),
            layerZeroBerachainEndpointId,
            bytes32(uint256(uint160(address(boringVault))))
        );
        _addLayerZeroLeafs(
        ...
        string
            memory filePath = "./leafs/Mainnet/LiquidBtcStrategistLeafs.json";
