...
contract CreateTestVault0MerkleRoot is Script, MerkleTreeHelper {
    ...
    address public rawDataDecoderAndSanitizer = address(12345);
    ...
    function generateStrategistMerkleRoot() public {
        ...
        gauges[0] = getAddress(sourceChain, "USDC_USDT_CL_GAUGE");
        _addVelodromeV3Leafs(leafs, token0, token1, getAddress(sourceChain, "velodromeNonFungiblePositionManager"), gauges);
        */
        // ========================== Verify ==========================
