...
/**
 *  source .env && forge script script/MerkleRootCreation/Ink/CreateTestBalancedUSDCMerkleRoot.s.sol --rpc-url $INK_RPC_URL --gas-limit 1000000000000000000
 */
contract CreateTestBalancedUSDCMerkleRoot is Script, MerkleTreeHelper {
    ...
    function generateStrategistMerkleRoot() public {
        ...
        string memory filePath = "./leafs/Ink/TestBalancedUSDCStrategistLeafs.json";
