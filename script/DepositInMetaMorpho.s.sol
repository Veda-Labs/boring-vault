...
contract DepositInMetaMorpho is Script, MerkleTreeHelper {
    ...
    function run() public {
        ...
        targets[1] = getAddress(sourceChain, "gauntletUSDCfrontier");

        bytes[] memory targetData = new bytes[](2);
        targetData[0] =
            abi.encodeWithSignature("approve(address,uint256)", getAddress(sourceChain, "gauntletUSDCfrontier"), 100e6);
        targetData[1] =
        ...
        manageLeafs[0].argumentAddresses[0] = getAddress(sourceChain, "gauntletUSDCfrontier");
        manageLeafs[1] = ManageLeaf(
            getAddress(sourceChain, "gauntletUSDCfrontier"),
            false,
        ...
        manageLeafs[1].argumentAddresses[0] = getAddress(sourceChain, "boringVault");
