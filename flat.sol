...
pragma solidity <0.9.0 =0.8.21 >=0.4.22 >=0.6.0 >=0.6.2 >=0.8.0 ^0.8.0 ^0.8.20;
 ...
 */
interface IERC1155Receiver is IERC165_1 {
    /**
...
// src/base/DecodersAndSanitizers/Protocols/LBTCBridgeDecoderAndSanitizer.sol
...
contract OdosDecoderAndSanitizer {
    ...
    function swapCompact() external view virtual returns (bytes memory addressesFound) {
        ...
        Address_1 memory inputTokenLookup;
        Address_1 memory outputTokenLookup;
        Address_1 memory executorLookup;
...
abstract contract ERC1155Holder is ERC165, IERC1155Receiver {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165_1) returns (bool) {
...
// src/base/DecodersAndSanitizers/KatanaDecoderAndSanitizer.sol
