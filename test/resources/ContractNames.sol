...
contract ContractNames {
    // Paravel USDC Test
    string public constant PrvlUSDCTestRolesAuthorityName = "Paravel USDC Test RolesAuthority Version 0.0";
    string public constant PrvlUSDCTestName = "Paravel USDC Test V0.0";
    string public constant PrvlUSDCTestManagerName = "Paravel USDC Test Manager With Merkle Verification V0.0";
    string public constant PrvlUSDCTestAccountantName = "Paravel USDC Test Accountant With Rate Providers V0.0";
    string public constant PrvlUSDCTestTellerName = "Paravel USDC Test Teller With Multi Asset Support V0.0";
    string public constant PrvlUSDCTestDecoderAndSanitizerName = "Paravel USDC Test Decoder and Sanitizer V0.0";
    string public constant PrvlUSDCTestDelayedWithdrawer = "Paravel USDC Test Delayed Withdrawer V0.0";

    // Paravel USDC Test Agent 1
    string public constant PrvlUSDCTestAgent1RolesAuthorityName = "Paravel USDC Test Agent 1 RolesAuthority Version 0.0";
    string public constant PrvlUSDCTestAgent1Name = "Paravel USDC Test Agent 1 V0.0";
    string public constant PrvlUSDCTestAgent1ManagerName = "Paravel USDC Test Agent 1 Manager With Merkle Verification V0.0";
    string public constant PrvlUSDCTestAgent1AccountantName = "Paravel USDC Test Agent 1 Accountant With Rate Providers V0.0";
    string public constant PrvlUSDCTestAgent1TellerName = "Paravel USDC Test Agent 1 Teller With Multi Asset Support V0.0";
    string public constant PrvlUSDCTestAgent1DecoderAndSanitizerName = "Paravel USDC Test Agent 1 Decoder and Sanitizer V0.0";
    string public constant PrvlUSDCTestAgent1DelayedWithdrawerName = "Paravel USDC Test Agent 1 Delayed Withdrawer V0.0";

    // Paravel WETH Test
    string public constant PrvlWETHTestRolesAuthorityName = "Paravel WETH Test RolesAuthority Version 0.0";
    string public constant PrvlWETHTestName = "Paravel WETH Test V0.0";
    string public constant PrvlWETHTestManagerName = "Paravel WETH Test Manager With Merkle Verification V0.0";
    string public constant PrvlWETHTestAccountantName = "Paravel WETH Test Accountant With Rate Providers V0.0";
    string public constant PrvlWETHTestTellerName = "Paravel WETH Test Teller With Multi Asset Support V0.0";
    string public constant PrvlWETHTestDecoderAndSanitizerName = "Paravel WETH Test Decoder and Sanitizer V0.0";
    string public constant PrvlWETHTestDelayedWithdrawer = "Paravel WETH Test Delayed Withdrawer V0.0";
