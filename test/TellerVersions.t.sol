...
contract TellerVersionsTest is Test, MerkleTreeHelper {
    ...
    AccountantWithYieldStreaming public yieldAccountant;
    ...
    function setUp() public {
        ...
        yieldAccountant = new AccountantWithYieldStreaming(address(this), address(boringVault), address(0), 1e18, getAddress(mainnet, "WETH"), 1.001e4, 0.999e4, 1, 0, 0);
        ...
        tellerWithYieldStreaming = new TellerWithYieldStreaming(address(this), address(boringVault), address(yieldAccountant), address(0));
