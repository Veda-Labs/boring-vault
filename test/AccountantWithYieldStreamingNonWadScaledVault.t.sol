...
contract AccountantWithYieldStreamingTest is Test, MerkleTreeHelper {
    ...
    function testDepositsWithYield() external {
        ...
        //==== BEGIN DEPOSIT 2 ====
        uint256 shares1 = teller.deposit(USDC, USDCAmount, 0, referrer);
        vm.assertApproxEqAbs(shares1, 6_666_666, 10); //
    ...
    function testFuzzWithdrawWithYield(uint96 WETHAmount, uint96 WETHAmount2, uint96 yieldVestAmount) external {
        ...
        assertApproxEqAbs(actualWithdrawn0, expectedWithdrawAmount0, 1e7, "First depositor withdraw amount mismatch");
        ...
        assertApproxEqAbs(
            actualWithdrawn0, firstDepositorExpectedValue, 1e7, "First depositor should get principal + yield share"
        );
        ...
        assertApproxEqAbs(actualWithdrawn1, expectedWithdrawAmount1, 1e7, "Second depositor withdraw amount mismatch");

        // Second depositor should get back approximately what they deposited (no yield share)
        assertApproxEqAbs(actualWithdrawn1, WETHAmount2, 1e7, "Second depositor should get back their deposit");
    }
