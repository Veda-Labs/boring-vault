...
exports.getEthersVersion = getEthersVersion;
...
function getEthersVersion(provider) {
    var _a;
    var constructorName = ((_a = provider === null || provider === void 0 ? void 0 : provider.constructor) === null || _a === void 0 ? void 0 : _a.name) || '';
    if (constructorName === 'Web3Provider' && provider._isProvider) {
        return 'isV5';
    }
    else {
        return 'isV6';
