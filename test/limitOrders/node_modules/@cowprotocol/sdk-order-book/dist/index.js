...
__export(src_exports, {
  ...
  OrderBookApiError: () => OrderBookApiError,
  OrderCancellationError: () => OrderCancellationError,
  OrderClass: () => OrderClass,
  OrderKind: () => OrderKind,
  OrderPostError: () => OrderPostError,
  OrderQuoteSideKindBuy: () => OrderQuoteSideKindBuy,
  OrderQuoteSideKindSell: () => OrderQuoteSideKindSell,
...
function transformEthFlowOrder(order) {
  ...
  const sellToken = import_sdk_config.ETH_ADDRESS;
...
var ORDER_BOOK_PROD_CONFIG = {
  ...
  [import_sdk_config2.SupportedChainId.ARBITRUM_ONE]: `${PROD_BASE_URL}/arbitrum_one`,
  [import_sdk_config2.SupportedChainId.BASE]: `${PROD_BASE_URL}/base`,
...
var ORDER_BOOK_STAGING_CONFIG = {
  ...
  [import_sdk_config2.SupportedChainId.GNOSIS_CHAIN]: `${STAGING_BASE_URL}/xdai`,
  [import_sdk_config2.SupportedChainId.ARBITRUM_ONE]: `${STAGING_BASE_URL}/arbitrum_one`,
  [import_sdk_config2.SupportedChainId.BASE]: `${STAGING_BASE_URL}/base`,
...
var OrderBookApi = class {
   ...
   */
  constructor(context = {}) {
    this.context = { ...import_sdk_config2.DEFAULT_COW_API_CONTEXT, ...context };
    this.rateLimiter = new import_limiter.RateLimiter(context.limiterOpts || DEFAULT_LIMITER_OPTIONS);
  }
  /**
  ...
  getTrades(request2, contextOverride = {}) {
    if (request2.owner && request2.orderUid) {
      return Promise.reject(new import_sdk_common.CowError("Cannot specify both owner and orderId"));
  ...
  getOrderMultiEnv(orderUid, contextOverride = {}) {
    ...
    const otherEnvs = import_sdk_config2.ENVS_LIST.filter((i) => i !== env);
    let attemptsCount = 0;
