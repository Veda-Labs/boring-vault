...
contract OneInchV6OwnedIntegrationTest is BaseTestIntegration {
    ...
    function testV6OwnedApproveAndSwap() external {
        ...
        tx_.targetData[1] =
            hex"";
    ...
    function testV6OwnedUnoswap() external {
        ...
        tx_.targetData[1] = abi.encodeWithSignature(
            "unoswap(uint256,uint256,uint256,uint256)", uint256(uint160(usdt)), 1_000e6, 900e6, uint256(uint160(pool1))
        );
    ...
    function testV6OwnedEthUnoswap() external {
        ...
        tx_.targetData[0] = abi.encodeWithSignature("ethUnoswap(uint256,uint256)", 900e18, uint256(uint160(pool1)));
    ...
    function testV6OwnedEthUnoswap2() external {
        ...
        tx_.targetData[0] = abi.encodeWithSignature(
            "ethUnoswap2(uint256,uint256,uint256)", 900e18, uint256(uint160(pool1)), uint256(uint160(pool2))
        );
    ...
    function testOwnedDecoderV6SwapReturnsThreeAddresses() external {
        address executor = 0x0BB7a4Fdea32910038DEc59c20ccAe3a6E66b09f;
        OneInchOwnedDecoderAndSanitizer decoder = new OneInchOwnedDecoderAndSanitizer(address(this), executor);
    ...
    function testOwnedDecoderUnoswap() external {
        OneInchOwnedDecoderAndSanitizer decoder = new OneInchOwnedDecoderAndSanitizer(address(this), address(1));
    ...
    function testOwnedDecoderUnoswap3() external {
        ...
        bytes memory result = decoder.unoswap3(tokenWithFlags, 1e6, 9e5, dex1WithFlags, dex2WithFlags, dex3WithFlags);
