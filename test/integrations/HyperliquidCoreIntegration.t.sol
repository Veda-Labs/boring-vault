...
contract FullHyperliquidCoreWriterDecoderAndSanitizer is HyperliquidCoreWriterDecoderAndSanitizer {}
...
contract HyperliquidCoreWriterIntegration is BaseTestIntegration {
    ...
    function testBridgeUsdcToCore() external {
        ...
        tx1.targets[0] = usdc;
        tx1.targetData[0] = abi.encodeWithSignature("approve(address,uint256)", coreDepositWallet, 500e6);
    ...
    function testBridgeHypeToCore_MerkleSetup() external {
        ...
        FullHyperliquidCoreWriterDecoderAndSanitizer decoder = new FullHyperliquidCoreWriterDecoderAndSanitizer();
