...
contract SiloVaultsIntegration is BaseTestIntegration {
    ...
    function _setUpSonic() internal {
        super.setUp();
        _setupChain("sonicMainnet", 25_048_440);
    ...
    function testSiloVaultsIntegration() external {
        ...
        tx_.targetData[1] = abi.encodeWithSignature("deposit(uint256,address)", 100e6, address(boringVault));
        ...
        //targetDatas
        tx_.targetData[0] = abi.encodeWithSignature("claimRewards()");
