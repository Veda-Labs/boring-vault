...
contract YearnIntegrationTest is BaseTestIntegration {
    function _setUpMainnet() internal {
        super.setUp();
        _setupChain("mainnet", 22_724_089);
    ...
    function testYearnWithdrawSlippageChecks() external {
        ...
        tx_.targetData[0] = abi.encodeWithSignature("approve(address,uint256)", yearnVault, type(uint256).max);
        tx_.targetData[1] = abi.encodeWithSignature("deposit(uint256,address)", 1e18, address(boringVault));
