...
contract EthenaMintingIntegrationTest is BaseTestIntegration {
    ...
    function testEthenaMint() external {
        ...
        IRoleGranter(0xe3490297a08d6fC8Da46Edb7B6142E4F461b62D3)
            .grantRole(0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6, address(boringVault));
        ...
        tx_.targetData[1] = abi.encodeWithSignature("setDelegatedSigner(address)", signer);
        ...
        DecoderCustomTypes.EthenaSignature memory signature =
            DecoderCustomTypes.EthenaSignature(DecoderCustomTypes.SignatureType.EIP712, sigBytes);
    ...
    function testEthenaRedeem() external {
        ...
        vm.startPrank(0x3B0AAf6e6fCd4a7cEEf8c92C32DFeA9E64dC1862);
        IRoleGranter(0xe3490297a08d6fC8Da46Edb7B6142E4F461b62D3)
            .grantRole(0x44ac9762eec3a11893fefb11d028bb3102560094137c3ed4518712475b2577cc, address(boringVault));
        IRoleGranter(getAddress(sourceChain, "ethenaMinterV2")).addWhitelistedBenefactor(address(boringVault));
        vm.stopPrank();
    ...
    function testEthenaMintRevertsIfSignerRemoved() external {
        ...
        tx_.targetData[0] = abi.encodeWithSignature("removeDelegatedSigner(address)", signer);
