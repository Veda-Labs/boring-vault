...
contract SwellSimpleStakingIntegrationTest is Test, MerkleTreeHelper {
    ...
    function testSwellSimpleStakingIntegration() external {
        ...
        targetData[1] = abi.encodeWithSignature(
            "deposit(address,uint256,address)", getAddress(sourceChain, "WETH"), 1000e18, address(boringVault)
        );
        targetData[2] = abi.encodeWithSignature(
            "withdraw(address,uint256,address)", getAddress(sourceChain, "WETH"), 1000e18, address(boringVault)
        );
    ...
    function testSwellSimpleStakingIntegrationViaDrone() external {
        deal(getAddress(sourceChain, "WETH"), address(boringDrone), 1000e18);
