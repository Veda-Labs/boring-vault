...
contract BalancerV3IntegrationTest is BaseTestIntegration {
    ...
    function testPermit2Lockdown() external {
        ...
        approvals[0] = DecoderCustomTypes.TokenSpenderPair(waETHUSDC, getAddress(sourceChain, "balancerV3Router"));

        tx_.targetData[2] = abi.encodeWithSignature("lockdown((address,address)[])", approvals);
    ...
    function testBalancerGaugeStaking0() external {
        ...
        tx_.targetData[9] = abi.encodeWithSignature("deposit(uint256,address)", 1e8, address(boringVault));
        ...
        tx_.targetData[0] = abi.encodeWithSignature("claim_rewards(address)", address(boringVault));
        tx_.targetData[1] = abi.encodeWithSignature("withdraw(uint256)", lpBalance);
    ...
    function testBalancerV3FullBoostedDepositFlow() external {
        ...
        //bytes[] memory targetData = new bytes[](7);
        tx_.targetData[0] = abi.encodeWithSignature("approve(address,uint256)", waETHUSDT, type(uint256).max);
        tx_.targetData[1] = abi.encodeWithSignature("deposit(uint256,address)", 1000e6, address(boringVault));
        tx_.targetData[2] = abi.encodeWithSignature("approve(address,uint256)", waETHGHO, type(uint256).max);
        tx_.targetData[3] = abi.encodeWithSignature("deposit(uint256,address)", 1000e18, address(boringVault));
        tx_.targetData[4] = abi.encodeWithSignature("approve(address,uint256)", waETHUSDC, type(uint256).max);
        tx_.targetData[5] = abi.encodeWithSignature("deposit(uint256,address)", 1000e6, address(boringVault));
        ...
        tx_.targetData[15] = abi.encodeWithSignature("deposit(uint256,address)", 1e8, address(boringVault));
    ...
    function testBalancerGaugeStaking__Sonic() external {
        ...
        tx_.targetData[7] = abi.encodeWithSignature("deposit(uint256,address)", 1e6, address(boringVault));
