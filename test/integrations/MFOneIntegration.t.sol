...
contract MFOneIntegrationTest is BaseTestIntegration {
    ...
    function testDeposit() external {
        ...
        IRoleGranter(0x0312A9D1Ff2372DDEdCBB21e4B6389aFc919aC4B)
            .grantRole(0xd2576bd6a4c5558421de15cb8ecdf4eb3282aac06b94d4f004e8cd0d00f3ebd8, address(boringVault));
    ...
    function testDepositRequest() external {
        ...
        tx_.targetData[1] = abi.encodeWithSignature(
            "depositRequest(address,uint256,bytes32)", getAddress(sourceChain, "USDC"), 1_000_000e18, bytes32(0)
        );
    ...
    function testReedemInstant() external {
        ...
        tx_.targetData[1] = abi.encodeWithSignature(
            "redeemInstant(address,uint256,uint256)", getAddress(sourceChain, "USDC"), 1_000_000e18, 0
        );
    ...
    function testReedemRequest() external {
        ...
        tx_.targetData[1] =
            abi.encodeWithSignature("redeemRequest(address,uint256)", getAddress(sourceChain, "USDC"), 1_000_000e18);
    ...
    function testReedemRequestFiat() external {
        ...
        tx_.targetData[1] = abi.encodeWithSignature("redeemFiatRequest(uint256)", 1_000_000e18);
