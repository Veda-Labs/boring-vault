...
contract EtherFiStethDepositIntegration is BaseTestIntegration {
    ...
    //the Liquifier was upgraded and depositWithERC20 gained a _minOutAmount param;
    //this exercises the current signature at a recent block
    function testStethDepositCurrentLiquifier() external {
        super.setUp();
        ...
        _addEtherFiLiquifierLeafs(leafs);
        ...
        tx_.manageLeafs[0] = leafs[0]; //approve STETH
        tx_.manageLeafs[1] = leafs[1]; //depositWithERC20
