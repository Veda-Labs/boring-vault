...
contract AccountantWithYieldStreamingTest is Test, MerkleTreeHelper {
    ...
    function testDepositsWithNoYield() external {
        ...
        uint256 shares0 = teller.deposit(DepositParams(WETH, WETHAmount, 0), referrer, ComplianceData(0, ""));
        ...
        //deposit 2
        uint256 shares1 = teller.deposit(DepositParams(WETH, WETHAmount, 0), referrer, ComplianceData(0, ""));
