...
contract AtomicQueueTest is Test, MerkleTreeHelper {
    ...
    function setUp() external {
        ...
        teller.deposit(DepositParams(WETH, 1_000e18, 0, address(0)), referrer, ComplianceData(0, ""));
        teller.deposit(DepositParams(WEETH, 1_000e18, 0, address(0)), referrer, ComplianceData(0, ""));
        vm.stopPrank();
    }
