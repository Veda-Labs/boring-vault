...
contract UniswapV3SwapRouter02DecoderAndSanitizer {
        ...
        returns (bytes memory addressesFound)
    {
        ...
        uint256 hops = pathLength / chunkSize; // multihop ex: 66 / 23 = 2.86 (floored) = 2
        uint256 pathIndex;
        ...
        addressesFound = abi.encodePacked(addressesFound, params.path[pathIndex:pathIndex + 20], params.recipient);
    }
        ...
        returns (bytes memory addressesFound)
    {
        // Nothing to sanitize
        // Return addresses found
        addressesFound = abi.encodePacked(params.token0, address(uint160(params.fee)), params.token1, params.recipient);
    }
