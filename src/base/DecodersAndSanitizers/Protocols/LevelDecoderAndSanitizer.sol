    ...
    EthenaWithdrawDecoderAndSanitizer
{
    ...
    function mintDefault(DecoderCustomTypes.LevelOrderV2 memory order)
        external
        pure
        virtual
    ...
    function mint(DecoderCustomTypes.LevelOrderV2 memory order)
        external
        pure
        virtual
        returns (bytes memory addressesFound)
    ...
    function completeRedeem(address asset, address beneficiary)
        external
        pure
        virtual
        returns (bytes memory addressesFound)
